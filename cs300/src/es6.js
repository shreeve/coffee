...
ES6Backend = class ES6Backend {
  ...
  reduce(values, positions, stackTop, symbolCount, directive) {
    var handler, lookup, o, outName, ref, result, util;
  ...
  processUse(o) {
    ...
    target = this.$(o.$use);
    if (o.method != null) {
      return typeof target# Missing $ops directive handler for: {"$ops":"prop","set":{"target":2,"property":"soak","value":true}} === "function" ? target# Missing $ops directive handler for: {"$ops":"prop","set":{"target":2,"property":"soak","value":true}}() : void 0;
    }
    if (o.prop != null) {
      return target# Missing $ops directive handler for: {"$ops":"prop","set":{"target":2,"property":"soak","value":true}};
    }
    if (o.index != null) {
      return target# Missing $ops directive handler for: {"$ops":"prop","set":{"target":2,"property":"soak","value":true}};
    }
  ...
  processOps(o) {
    var accessor, body, elseBody, i, ifNode, item, len, loopNode, ref, resolved, result, sourceInfo, util, value;
    switch (o.$ops) {
      case "array":
        result = [];
        if (o.append != null) {
      ...
      case "if":
        if (o.addElse != null) {
          [ifNode, elseBody] = o.addElse.map(function(item) {
            return this.$(item);
          });
      ...
      case "value":
        if (o.add != null) {
          [value, accessor] = o.add.map(function(item) {
            return this.$(item);
          });
      ...
      case "loop":
        if (o.addSource != null) {
          [loopNode, sourceInfo] = o.addSource.map(function(item) {
            return this.$(item);
          });
        ...
        if (o.addBody != null) {
          ...
          [loopNode, body] = o.addBody.map(function(item) {
            return this.$(item);
          });
...
# Missing AST node: ExportDefaultDeclaration;

# Missing AST node: ExportNamedDeclaration;
