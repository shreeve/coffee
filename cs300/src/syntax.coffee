...
grammar =
  ...
  ForBody: [
    o 'FOR Range'              , $ast: 'For', body: {$arr: []}, source: {$ast: 'Value', val: 2, $pos: 2}
    o 'FOR Range BY Expression', $ast: 'For', body: {$arr: []}, source: {$ast: 'Value', val: 2, $pos: 2}, step: 4
    o 'ForStart ForSource'     , $ops: 'loop', addSource: [1, 2]
  ]

  ForLineBody: [
    o 'FOR Range BY ExpressionLine', $ast: 'For', body: {$arr: []}, source: {$ast: 'Value', val: 2, $pos: 2}, step: 4
