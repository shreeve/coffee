...
class Generator
  ...
  generate: (options = {}) ->
    ...
    parserCode = @generateES6Module @options
  ...
  generateES6Module: (options = {}) ->
    ...
    # Generate complete ES6 module with exports
    """
    /* Parser generated by Solar #{VERSION} */
  ...
  generateModule: (options = {}) ->
    ...
    # For ES6, generate flat module code without IIFE
    """
    /* Parser generated by Solar #{VERSION} */
    const hasProp = {}.hasOwnProperty;
    #{module.commonCode}
  ...
  generateModuleExpr: ->
    # This method is no longer needed for ES6, but keep for backward compatibility
    @generateModule()
  ...
  createParser: ->
    ...
    parser.generateES6Module = bindMethod 'generateES6Module'
