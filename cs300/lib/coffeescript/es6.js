...
class ES6Backend {
  ...
  reduce(values, positions, stackTop, symbolCount, directive) {
    let handler, lookup, o, outName, ref, ref1, ref2, ref3, result, util;
  ...
  processOps(o) {
    let accessor, body, elseBody, i, ifNode, item, len, loopNode, ref, ref1, ref2, ref3, ref4, ref5, resolved, result, sourceInfo, util, value;
    switch (o.$ops) {
      case 'array':
        result = [];
        if (o.append != null) {
