...
import { compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, isFunction, isPlainObject, isNumber, parseNumber } from './helpers.js';
...
export const RegexLiteral = (function() {
...
export const IdentifierLiteral = (function() {
...
export const PropertyName = (function() {
...
export const StatementLiteral = (function() {
...
export const FuncDirectiveReturn = (function() {
...
export const MetaProperty = (function() {
...
export const JSXExpressionContainer = (function() {
...
export const JSXAttribute = (function() {
...
export const JSXAttributes = (function() {
...
export const JSXNamespacedName = (function() {
...
export const JSXElement = (function() {
...
export const RegexWithInterpolations = (function() {
...
export const ExecutableClassBody = (function() {
...
export const ClassProperty = (function() {
...
export const ClassPrototypeProperty = (function() {
...
//### Import and Export
export const ModuleDeclaration = (function() {
...
export const ImportClause = (function() {
...
export const ModuleSpecifierList = (function() {
...
export const ModuleSpecifier = (function() {
...
export const Code = (function() {
    class Code extends Base {
      ...
      compileNode(o) {
        ...
        this.eachParamName(function(name, node, param, obj) {
          ...
          if (node && node.base instanceof ThisLiteral) {
            ...
            if (isDerivedConstructor) {
              ...
              const assignment = new Assign(thisNode, target);
        ...
        // ES6: Handle @params in derived constructors - move after super()
        const hasThisParams = this.ctor === 'derived' && this.params.some(param =>
          param.name && param.name.base instanceof ThisLiteral
        );
        this.disallowSuperInParamDefaults({forAst: hasThisParams});
        if (!hasThisParams) {
      ...
      eachSuperCall(context, iterator, {checkForThisBeforeSuper = true} = {}) {
        ...
        context.traverseChildren(true, (child) => {
          ...
          if (child instanceof SuperCall) {
            ...
            // ES6: Skip error for @param 'this' references - they'll move after super()
      ...
      astNode(o) {
        ...
        seenSuper = hasThisParams
          ? this.eachSuperCall(this.body, () => {}, {checkForThisBeforeSuper: false})
          : this.checkSuperCallsInConstructorBody();
...
// parameter list.
export const Expansion = (function() {
...
export const Existence = (function() {
...
export const StringWithInterpolations = (function() {
...
export const Interpolation = (function() {
...
export const SwitchWhen = (function() {
