...
let UNICODE_CODE_POINT_ESCAPE, buildLocationData, buildLocationHash, ref, syntaxErrorToString, unicodeCodePointToUnicodeEscapes;
let indexOf = [].indexOf;
...
export const invertLiterate = function(code) {
...
export const isLiterate = function(file) {
