...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    processAst(o) {
      var args, base, body, elseBody, exclusive, expression, ifNode, index, name, options, props, ref, ref1, ref2, whileNode;
      switch (o.$ast) {
        case '@':
        ...
        // Value and Access
        case 'Value':
          base = (ref = (ref1 = this.$(o.base)) != null ? ref1 : this.$(o.value)) != null ? ref : this.$(o.val);
          props = (ref2 = this.$(o.properties)) != null ? ref2 : [];
