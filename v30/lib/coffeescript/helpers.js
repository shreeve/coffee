...
var UNICODE_CODE_POINT_ESCAPE, buildLocationData, buildLocationHash, syntaxErrorToString, unicodeCodePointToUnicodeEscapes,
  indexOf = [].indexOf;
...
export var extractAllCommentTokens = function(tokens) {
  var allCommentsObj, comment, commentKey, i, j, k, key, len1, len2, len3, ref, results, sortedKeys, token;
  allCommentsObj = {};
...
syntaxErrorToString = function() {
  var codeLine, colorize, colorsEnabled, end, filename, first_column, first_line, last_column, last_line, marker, ref, ref1, ref2, start;
