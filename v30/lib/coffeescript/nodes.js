...
var HEREGEX_OMIT, LEADING_BLANK_LINE, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, NEGATE, NO, SIMPLENUM, SIMPLE_STRING_OMIT, STRING_OMIT, Scope, SwitchCase, TAB, THIS, TRAILING_BLANK_LINE, UTILITIES, YES, astAsBlockIfNeeded, emptyExpressionLocationData, extractSameLineLocationDataFirst, extractSameLineLocationDataLast, fragmentsToText, greater, hasLineComments, indentInitial, isAstLocGreater, isLiteralArguments, isLiteralThis, isLocationDataEndGreater, isLocationDataStartGreater, lesser, makeDelimitedLiteral, moveComments, multident, shouldCacheOrIsAssignable, sniffDirectives, unfoldSoak, unshiftAfterComments, utility, zeroWidthLocationDataFromEndLocation,
  indexOf = [].indexOf,
  splice = [].splice,
  slice1 = [].slice;
...
export var Block = (function() {
  class Block extends Base {
    ...
    static wrap(nodes) {
      var block, first, last, ref1, ref2, ref3, ref4;
...
export var Range = (function() {
  class Range extends Base {
    ...
    compileNode(o) {
      var cond, condPart, from, gt, idx, idxName, known, lowerBound, lt, namedIndex, stepCond, stepNotZero, stepPart, to, upperBound, varPart;
      if (!this.fromVar) {
...
export var ObjectProperty = class ObjectProperty extends Base {
  ...
  astProperties(o) {
    var isComputedPropertyName, keyAst, ref1;
...
export var ExecutableClassBody = (function() {
  class ExecutableClassBody extends Base {
    ...
    compileNode(o) {
      var args, argumentsNode, directives, externalCtor, ident, jumpNode, klass, params, parent, wrapper;
      if (jumpNode = this.body.jumps()) {
        jumpNode.error('Class bodies cannot contain pure statements');
      }
      if (argumentsNode = this.body.contains(isLiteralArguments)) {
...
export var Param = (function() {
  class Param extends Base {
    ...
    eachName(iterator, name = this.name) {
      var atParam, checkAssignabilityOfLiteral, j, len1, nObj, node, obj, ref1;
...
export var For = (function() {
  class For extends While {
    ...
    addSource(source) {
      var attr, attribs, attribute, base1, j, k, len1, len2, ref1, ref2, ref3;
...
export var If = (function() {
  class If extends Base {
    ...
    astProperties(o) {
      var isStatement, ref1, ref2, ref3;
