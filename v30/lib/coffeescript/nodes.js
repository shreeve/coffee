...
let HEREGEX_OMIT, LEADING_BLANK_LINE, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, NEGATE, NO, SIMPLENUM, SIMPLE_STRING_OMIT, STRING_OMIT, Scope, SwitchCase, TAB, THIS, TRAILING_BLANK_LINE, UTILITIES, YES, astAsBlockIfNeeded, emptyExpressionLocationData, extractSameLineLocationDataFirst, extractSameLineLocationDataLast, fragmentsToText, greater, hasLineComments, indentInitial, isAstLocGreater, isLiteralArguments, isLiteralThis, isLocationDataEndGreater, isLocationDataStartGreater, lesser, makeDelimitedLiteral, moveComments, multident, shouldCacheOrIsAssignable, sniffDirectives, unfoldSoak, unshiftAfterComments, utility, zeroWidthLocationDataFromEndLocation,
  indexOf = [].indexOf,
  splice = [].splice,
  slice1 = [].slice;
...
Scope = class Scope {
  constructor(parent1, expressions1, method1, referencedVars) {
    ...
    this.root = ((ref1 = this.parent) != null ? ref1.root : void 0) ?? this;
  }
  ...
  declaredVariables() {
    ...
    return ((function() {
      let results1;
this.variables.filter((v) => v.type === 'var')
    }).call(this)).sort();
  }

  assignedVariables() {
    let results1, v;
this.variables.filter((v) => v.type.assigned).map((v) => `${v.name} = ${v.type.value}`)
  }
...
export let HoistTarget = class HoistTarget extends Base {
  ...
  compileToFragments(o, level) {
    ...
    this.options.level = level ?? o.level;
...
export let Root = (function() {
  class Root extends Base {
    ...
    initializeScope(o) {
      let name, results1;
      o.scope = new Scope(null, this.body, null, o.referencedVars ?? []);
o.locals || [].map((name) => o.scope.parameter(name))
    }

    commentsAst() {
      let comment, commentToken, results1;
      if (this.allComments == null) {
        this.allComments = (function() {
          let results1;
this.allCommentTokens ?? [].filter((commentToken) => !commentToken.heregex).map((commentToken) => commentToken.here ? new HereComment(commentToken) : new LineComment(commentToken))
        }).call(this);
      }
this.allComments.map((comment) => comment.ast())
    }
...
export let Block = (function() {
  class Block extends Base {
    ...
    makeReturn(results, mark) {
      let expr, lastExp, len, ref1, ref2;
    ...
    compileComments(fragments) {
      ...
      for (fragmentIndex = j = 0, len1 = fragments.length; j < len1; fragmentIndex = ++j) {
        ...
        if (fragment.precedingComments) {
          ...
          code = `\n${fragmentIndent}` + ((() => {
            let results1;
fragment.precedingComments.map((commentFragment) => commentFragment.isHereComment && commentFragment.multiline ? multident(commentFragment.code, fragmentIndent, false) : commentFragment.code)
        ...
        if (fragment.followingComments) {
          ...
          code += (fragment.followingComments.map((commentFragment) => commentFragment.isHereComment && commentFragment.multiline ? multident(commentFragment.code, fragmentIndent, false) : commentFragment.code)).join(`\n${fragmentIndent}`).replace(/^(\s*)$/gm, '');
    ...
    static wrap(nodes) {
      let block, first, last, ref1, ref2, ref3, ref4;
      ...
      if (nodes.length > 0 && ((ref1 = (first = nodes[0])) != null ? ref1.locationData : void 0) && ((ref2 = (last = nodes[nodes.length - 1])) != null ? ref2.locationData : void 0)) {
        block.locationData = {
          ...
          range: [((ref3 = first.locationData.range) != null ? ref3[0] : void 0) ?? 0, ((ref4 = last.locationData.range) != null ? ref4[1] : void 0) ?? 0]
        };
      }
      return block;
    }
  ...
  class RegexLiteral extends Literal {
    ...
    astProperties(o) {
      ...
      return {
        ...
        comments: (function() {
          let results1;
this.heregexCommentTokens.map((heregexCommentToken) => heregexCommentToken.here ? new HereComment(heregexCommentToken).ast(o) : new LineComment(heregexCommentToken).ast(o))
        }).call(this)
      };
    }
...
export let Return = (function() {
  class Return extends Base {
    ...
    astProperties(o) {
      let ref1;
      return {
        argument: ((ref1 = this.expression) != null ? ref1.ast(o, LEVEL_PAREN) : void 0) ?? null
      };
    }
...
export let Value = (function() {
  class Value extends Base {
    ...
    unfoldSoak(o) {
      return this.unfoldedSoak != null ? this.unfoldedSoak : this.unfoldedSoak = ifn = this.base.unfoldSoak(o);
        if (ifn) {
    ...
    object() {
      let adjustedLocationData, initialProperties, lastProp, object, ref1;
      if (!this.hasProperties()) {
        return this;
      }
...
export let Call = (function() {
  class Call extends Base {
    ...
    compileNode(o) {
      ...
      argCode = (function() {
        let results1;
this.args || [].filter((arg) => arg instanceof Code)
      }).call(this);
    ...
    astProperties(o) {
      ...
      return {
        ...
        arguments: (function() {
          let results1;
this.args.map((arg) => arg.ast(o, LEVEL_LIST))
        }).call(this),
        optional: !!this.soak,
  ...
  class Super extends Base {
    ...
    astNode(o) {
      ...
      if (this.accessor != null) {
        return (new Value(new Super().withLocationDataFrom(this.superLiteral ?? this), [this.accessor]).withLocationDataFrom(this)).ast(o);
      }
      return super.astNode(o);
    }
...
export let RegexWithInterpolations = (function() {
  class RegexWithInterpolations extends Base {
    ...
    astProperties(o) {
      let heregexCommentToken, ref1;
      return {
        interpolatedPattern: this.call.args[0].ast(o),
        flags: ((ref1 = this.call.args[1]) != null ? ref1.unwrap().originalValue : void 0) ?? '',
        comments: (function() {
          let results1;
this.heregexCommentTokens.map((heregexCommentToken) => heregexCommentToken.here ? new HereComment(heregexCommentToken).ast(o) : new LineComment(heregexCommentToken).ast(o))
        }).call(this)
...
export let Range = (function() {
  class Range extends Base {
    ...
    compileNode(o) {
      let cond, condPart, from, gt, idx, idxName, known, lowerBound, lt, namedIndex, stepCond, stepNotZero, stepPart, to, upperBound, varPart;
      if (!this.fromVar) {
      ...
      stepNotZero = `${this.stepNum ?? this.stepVar} !== 0`;
      stepCond = `${this.stepNum ?? this.stepVar} > 0`;
    ...
    astProperties(o) {
      let ref1, ref2;
      return {
        from: ((ref1 = this.from) != null ? ref1.ast(o) : void 0) ?? null,
        to: ((ref2 = this.to) != null ? ref2.ast(o) : void 0) ?? null,
...
export let Obj = (function() {
  class Obj extends Base {
    ...
    expandProperties() {
      let property, results1;
this.properties.map((property) => this.expandProperty(property))
    }

    propagateLhs(setLhs) {
      let property, results1, unwrappedValue, value;
      if (setLhs) {
        this.lhs = true;
      }
      if (!this.lhs) {
...
this.properties.map((property) => property instanceof Assign && property.context === 'object' ? (({value} = property), unwrappedValue = value.unwrapAll(), unwrappedValue instanceof Arr || unwrappedValue instanceof Obj ? unwrappedValue.propagateLhs(true) : unwrappedValue instanceof Assign ? unwrappedValue.nestedLhs = true : void 0) : property instanceof Assign ? property.nestedLhs = true : property instanceof Splat ? property.propagateLhs(true) : void 0)
    }
    ...
    astProperties(o) {
      ...
      return {
        ...
        properties: (function() {
          let results1;
this.expandProperties().map((property) => property.ast(o))
        }).call(this)
      };
    }
...
export let ObjectProperty = class ObjectProperty extends Base {
  ...
  astProperties(o) {
    let isComputedPropertyName, keyAst, ref1;
    ...
    return {
      ...
      value: ((ref1 = this.value) != null ? ref1.ast(o, LEVEL_LIST) : void 0) ?? keyAst,
      shorthand: !!this.shorthand,
...
export let Arr = (function() {
  class Arr extends Base {
    ...
    isAssignable(opts) {
      ...
      ({allowExpansion, allowNontrailingSplat, allowEmptyArray = false} = opts ?? {});
    ...
    compileNode(o) {
      ...
      compiledObjs = (function() {
        let results1;
this.objects.map((obj) => obj.compileToFragments(o, LEVEL_LIST))
      }).call(this);
    ...
    astProperties(o) {
      ...
      return {
        elements: (function() {
          let results1;
this.objects.map((object) => object.ast(o, LEVEL_LIST))
        }).call(this)
      };
    }
    ...
    walkBody(o) {
      ...
      if (initializer.length !== expressions.length) {
        this.body.expressions = (() => {
          let results1;
initializer.map((expression) => expression.hoist());
    ...
    astProperties(o) {
      let ref1, ref2;
      return {
        id: ((ref1 = this.variable) != null ? ref1.ast(o) : void 0) ?? null,
        superClass: ((ref2 = this.parent) != null ? ref2.ast(o, LEVEL_PAREN) : void 0) ?? null,
...
export let ExecutableClassBody = (function() {
  class ExecutableClassBody extends Base {
    ...
    compileNode(o) {
      let args, argumentsNode, directives, externalCtor, ident, jumpNode, klass, params, parent, wrapper;
      if (jumpNode = this.body.jumps()) {
        jumpNode.error('Class bodies cannot contain pure statements');
      }
      if (argumentsNode = this.body.contains(isLiteralArguments)) {
      ...
      this.name = this.class.name ?? o.classScope.freeVariable(this.defaultClassVariableName);
  ...
  class ClassProperty extends Base {
    ...
    astProperties(o) {
      ...
      return {
        ...
        operator: ((ref1 = this.operatorToken) != null ? ref1.value : void 0) ?? '=',
        staticClassName: ((ref2 = this.staticClassName) != null ? ref2.ast(o) : void 0) ?? null
      };
    }
...
export let ImportDeclaration = class ImportDeclaration extends ModuleDeclaration {
  ...
  astProperties(o) {
    let ref1, ret;
    ret = {
      specifiers: ((ref1 = this.clause) != null ? ref1.ast(o) : void 0) ?? [],
...
export let ExportNamedDeclaration = class ExportNamedDeclaration extends ExportDeclaration {
  astProperties(o) {
    ...
    ret = {
      source: ((ref1 = this.source) != null ? ref1.ast(o) : void 0) ?? null,
      assertions: this.astAssertions(o),
      exportKind: 'value'
    };
  ...
  class ModuleSpecifierList extends Base {
    ...
    compileNode(o) {
      ...
      compiledList = (function() {
        let results1;
this.specifiers.map((specifier) => specifier.compileToFragments(o, LEVEL_LIST))
      }).call(this);
    ...
    astNode(o) {
      let results1, specifier;
this.specifiers.map((specifier) => specifier.ast(o))
    }
...
export let ImportSpecifier = class ImportSpecifier extends ModuleSpecifier {
  ...
  astProperties(o) {
    let originalAst, ref1;
    originalAst = this.original.ast(o);
    return {
      imported: originalAst,
      local: ((ref1 = this.alias) != null ? ref1.ast(o) : void 0) ?? originalAst,
      importKind: null
    };
  }
...
export let ExportSpecifier = class ExportSpecifier extends ModuleSpecifier {
  ...
  astProperties(o) {
    ...
    return {
      local: originalAst,
      exported: ((ref1 = this.alias) != null ? ref1.ast(o) : void 0) ?? originalAst
    };
  }
...
export let Assign = (function() {
  class Assign extends Base {
    ...
    astProperties(o) {
      ...
      if (!this.isDefaultAssignment()) {
        ret.operator = this.originalContext ?? '=';
      }
      return ret;
    }
...
export let Code = (function() {
  class Code extends Base {
    ...
    compileNode(o) {
      ...
      params = [];
      exprs = [];
      thisAssignments = ((ref2 = this.thisAssignments) != null ? ref2.slice() : void 0) ?? [];
      paramsAfterSplat = [];
      ...
      for (i = j = 0, len1 = ref3.length; j < len1; i = ++j) {
        ...
        if (param.splat || param instanceof Expansion) {
          ...
          if (!haveSplatParam) {
            ...
            if (((ref4 = param.name) != null ? ref4.value : void 0) != null) {
      ...
      if (paramsAfterSplat.length !== 0) {
        exprs.unshift(new Assign(new Value(new Arr([
          ...
          ...((() => {
            let results1;
paramsAfterSplat.map((param) => param.asReference(o))
          })())
      ...
      if (((ref5 = this.paramStart) != null ? ref5.comments : void 0) != null) {
      ...
      answer = this.joinFragmentArrays((function() {
        let results1;
modifiers.map((m) => this.makeCode(m))
      }).call(this), ' ');
    ...
    eachParamName(iterator) {
      let param, results1;
this.params.map((param) => param.eachName(iterator))
    }
    ...
    disallowLoneExpansionAndMultipleSplats() {
      let param, results1, seenSplatParam;
      seenSplatParam = false;
this.params.map((param) => param.splat || param instanceof Expansion ? (seenSplatParam ? param.error('only one splat or expansion parameter is allowed per function definition') : param instanceof Expansion && this.params.length === 1 ? param.error('an expansion parameter cannot be the only parameter in a function definition') : void 0, seenSplatParam = true) : void 0)
    }
    ...
    methodAstProperties(o) {
      ...
      return {
        ...
        operator: ((ref1 = this.operatorToken) != null ? ref1.value : void 0) ?? '=',
        staticClassName: ((ref2 = this.isStatic.staticClassName) != null ? ref2.ast(o) : void 0) ?? null,
        bound: !!this.bound
      };
    }
    ...
    astProperties(o) {
      ...
      return Object.assign({
        params: (function() {
          let results1;
this.params.map((param) => this.paramForAst(param).ast(o))
        }).call(this),
  ...
  class While extends Base {
    ...
    astProperties(o) {
      ...
      return {
        ...
        body: this.body.ast(o, LEVEL_TOP),
        guard: ((ref1 = this.guard) != null ? ref1.ast(o) : void 0) ?? null,
...
export let Op = (function() {
  ...
  class Op extends Base {
    ...
    chainAstProperties(o) {
      ...
      return {
        operators,
        operands: operands.map((operand) => operand.ast(o, LEVEL_OP))
      };
    }
  ...
  class Try extends Base {
    ...
    astProperties(o) {
      ...
      return {
        ...
        handler: ((ref1 = this.catch) != null ? ref1.ast(o) : void 0) ?? null,
...
export let Catch = (function() {
  class Catch extends Base {
    ...
    astProperties(o) {
      let ref1;
      return {
        param: ((ref1 = this.errorVariable) != null ? ref1.ast(o) : void 0) ?? null,
...
export let For = (function() {
  class For extends While {
    ...
    addSource(source) {
      let attr, attribs, attribute, base1, j, k, len1, len2, ref1, ref2, ref3;
      ...
      for (j = 0, len1 = attribs.length; j < len1; j++) {
        attr = attribs[j];
        this[attr] = source[attr] ?? this[attr];
      }
      if (!this.source) {
        return this;
      }
    ...
    compileNode(o) {
      let body, bodyCode, bodyExpr, bodyFragments, compare, compareDown, declare, declareDown, defPart, down, forClose, forCode, forPartFragments, fragments, guardCode, guardPart, idt1, increment, index, isFilterOnly, ivar, kvar, kvarAssign, last, lvar, name, namePart, nameVar, ref, ref1, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, varPart;
    ...
    astProperties(o) {
      ...
      return {
        ...
        body: this.body.ast(o, LEVEL_TOP),
        guard: ((ref2 = this.guard) != null ? ref2.ast(o) : void 0) ?? null,
        name: ((ref3 = this.name) != null ? ref3.ast(o) : void 0) ?? null,
        index: ((ref4 = this.index) != null ? ref4.ast(o) : void 0) ?? null,
        step: ((ref5 = this.step) != null ? ref5.ast(o) : void 0) ?? null,
        postfix: !!this.postfix,
        own: !!this.own,
        await: !!this.await,
        style: (function() {
...
export let Switch = (function() {
  class Switch extends Base {
    ...
    casesAst(o) {
      let caseIndex, caseLocationData, cases, consequent, j, k, kase, lastTestIndex, len1, len2, ref1, ref2, results1, test, testConsequent, testIndex, tests;
      cases = [];
      ref1 = this.cases;
...
cases.map((kase) => kase.ast(o))
    }

    astProperties(o) {
      let ref1;
      return {
        discriminant: ((ref1 = this.subject) != null ? ref1.ast(o, LEVEL_PAREN) : void 0) ?? null,
...
SwitchCase = (function() {
  class SwitchCase extends Base {
    ...
    astProperties(o) {
      let ref1, ref2;
      return {
        test: ((ref1 = this.test) != null ? ref1.ast(o, LEVEL_PAREN) : void 0) ?? null,
        consequent: ((ref2 = this.block) != null ? ref2.ast(o, LEVEL_TOP).body : void 0) ?? [],
...
export let If = (function() {
  class If extends Base {
    ...
    astProperties(o) {
      let isStatement, ref1, ref2, ref3;
      ...
      return {
        ...
        alternate: this.isChain ? this.elseBody.unwrap().ast(o, isStatement ? LEVEL_TOP : LEVEL_COND) : !isStatement && ((ref1 = this.elseBody) != null ? (ref2 = ref1.expressions) != null ? ref2.length : void 0 : void 0) === 1 ? this.elseBody.expressions[0].ast(o, LEVEL_TOP) : ((ref3 = this.elseBody) != null ? ref3.ast(o, LEVEL_TOP) : void 0) ?? null,
        postfix: !!this.postfix,
    ...
    astProperties(o) {
      ...
      return {
        expressions: (function() {
          let results1;
this.expressions.map((expression) => expression.ast(o))
        }).call(this)
      };
    }
