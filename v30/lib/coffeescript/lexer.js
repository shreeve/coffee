...
export let Lexer = class Lexer {
  ...
  identifierToken() {
    let alias, colon, colonOffset, colonToken, id, idLength, input, match, poppedToken, prev, prevprev, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, regExSuper, sup, tag, tagToken, tokenData;
  ...
  literalToken() {
    let match, message, origin, prev, ref, ref1, ref2, ref3, ref4, skipToken, tag, token, value;
  ...
  mergeInterpolationTokens(tokens, options, fn) {
    let $, converted, double, endOffset, firstIndex, heregex, i, indent, j, k, lastToken, len, len1, locationToken, lparen, placeholderToken, quote, rparen, tag, token, tokensToPush, val, value;
  ...
  validateEscapes(str, options = {}) {
    let before, hex, invalidEscape, invalidEscapeRegex, match, message, octal, unicode, unicodeCodePoint;
  ...
  error(message, options = {}) {
    let first_column, first_line, location;
