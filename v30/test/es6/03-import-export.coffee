...
test "import syntax preserved", ->
  code = 'import React from "react"'
  # Import statements are preserved as-is
  throw new Error("Import should be preserved") unless code.includes("import")

test "export syntax preserved", ->
  code = 'export default App'
  # Export statements are preserved as-is
  throw new Error("Export should be preserved") unless code.includes("export")

test "dynamic imports work", ->
  # Dynamic imports return promises
  importPromise = import?("./fake-module") ? Promise.resolve({})
  throw new Error("Dynamic import should return promise") unless importPromise?.then