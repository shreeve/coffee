...
exports.ExportDeclaration = class ExportDeclaration extends ModuleDeclaration
  compileNode: (o) ->
    ...
    if @ not instanceof ExportDefaultDeclaration and
      ...
      # Use 'let' instead of 'var' for consistency with our pure let philosophy
...
exports.Assign = class Assign extends Base
  ...
  isStatement: (o) ->
    ...
    o?.level is LEVEL_TOP and @context? and (@moduleDeclaration or ("?" in @context and not process.env.ES6))
  ...
  compileNode: (o) ->
    ...
    if isValue
      ...
      return @compileConditional  o if @isConditional() and not (@context is '?=' and process.env.ES6)
    ...
    operator = if @context is '?=' and process.env.ES6 then '??=' else (@context or '=')
...
# ```
mergeLocationData = exports.mergeLocationData = (locationDataA, locationDataB, {justLeading, justEnding} = {}) ->
  return Object.assign(
    if justEnding
...
# ```
mergeAstLocationData = exports.mergeAstLocationData = (nodeA, nodeB, {justLeading, justEnding} = {}) ->
  return
    loc:
      start:
        if justEnding
...
convertLocationDataToAst = exports.convertLocationDataToAst = ({first_line, first_column, last_line_exclusive, last_column_exclusive, range}) ->
  return
    loc:
      start:
        line:   first_line + 1
