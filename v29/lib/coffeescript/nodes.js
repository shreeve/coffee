...
const Scope = class Scope {
  ...
  temporary(name, index, single = false) {
    let startCode, endCode, diff, newCode, letter, num;
    if (single) {
...
/* DEFPART_MARKER */
  ...
  freeVariable(name, options = {}) {
    ...
    while (true) {
      ...
      if (!(this.check(temp) || this.root.referencedVars.includes(temp))) {
        break;
      }
      index++;
    }
...
export class HereComment extends Base {
  ...
  compileNode(o) {
    let multiline = this.content.includes('\n');
...
export class ImportDeclaration extends ModuleDeclaration {
  compileNode(o) {
    ...
    let sourceValue, unquoted, quoteMark;
    if (((ref1 = this.source) != null ? ref1.value : void 0) != null) {
      ...
      if (process.env.ES6 && this.source.value.match(/\.json['"]$/) && (this.assertions == null)) {
...
export class ImportSpecifier extends ModuleSpecifier {
  ...
  addIdentifierToScope(o) {
    if ((ref1 = this.identifier, o.importedSymbols.includes(ref1)) || o.scope.check(this.identifier)) {
